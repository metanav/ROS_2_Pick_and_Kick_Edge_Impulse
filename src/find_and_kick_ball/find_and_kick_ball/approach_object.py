...
class ApproachObject:
    def __init__(self, gait_manager, calib_cofig, step_mode=1, debug=False):
        self.calib_config = calib_cofig
        self.debug = debug
        self.count_stop = 0
        self.stop_count = 0
    ...
    def process(self, max_y, center_x, angle, x_stop, y_stop, yaw_stop, width, height):
        info = self.gait_manager.node.get_logger().info
        #info("process 1")
